        ...
        <!-- Widgets -->
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box-3 bg-pink hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">Avg Workout(%)</div>
                        <div class="number count-to" data-from="0" data-to="80" data-speed="15" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box-3 bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">Avg Pressure Points per day</div>
                        <div class="number count-to" data-from="0" data-to="480" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
